export const siteConfig = {
  ...
  description:
    "1-on-1 Japanese lessons with native speakers. From $10/30min. Join 50,000+ learners.",
  ...
  howItWorks: [
    ...
    },
    {
      ...
      titleJa: "予約する",
      description:
        "Choose a time that works for you. 30 minute lessons. No complicated scheduling.",
      icon: "Calendar",
    },
    {
      step: "03",
  ...
  pricing: {
    ...
    tiers: [
      { duration: "30 min", price: "from $10", description: "One focused lesson" },
    ],
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Every lesson is 30 minutes — long enough for meaningful practice, short enough to fit into a busy day.",
    },
    {
