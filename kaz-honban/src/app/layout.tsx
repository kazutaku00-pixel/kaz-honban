...
export const metadata: Metadata = {
  ...
  description:
    "1-on-1 Japanese lessons with native speakers. From $10/30min. Personalized to your level, schedule, and goals.",
  openGraph: {
    title: "NihonGo — Learn Japanese with Real Teachers",
    description:
      "1-on-1 Japanese lessons with native speakers. From $10/30min.",
    type: "website",
  },
  appleWebApp: {
    capable: true,
