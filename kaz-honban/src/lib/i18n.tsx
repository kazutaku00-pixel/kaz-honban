...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "schedule.to": "to",
    "schedule.add": "Add",
    "schedule.generate": "Sync slots now",
    "schedule.syncHint": "Slots auto-sync when you edit a template. Use this to force a refresh.",
    "schedule.synced": "Synced.",
    "schedule.syncedDetail": "Created {created}, removed {pruned}.",
  ...
  ja: {
    ...
    "schedule.to": "〜",
    "schedule.add": "追加",
    "schedule.generate": "今すぐスロット同期",
    "schedule.syncHint": "テンプレート編集時に自動で同期されます。手動で更新したいときに使用。",
    "schedule.synced": "同期完了",
    "schedule.syncedDetail": "追加 {created}件 / 削除 {pruned}件",
